...
SELECT * FROM BOOKS ORDER BY book_name ASC, book_cost DESC;
...
SELECT book_name, publishing_date, DATE_FORMAT(publishing_date, '%d/%m/%Y') AS FORMATTED_DATE FROM BOOKS;
